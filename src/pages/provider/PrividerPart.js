            ...
            <div className="provider-part position-relative">
                ...
                <div className="iptelephony-part-three-child container">
                    <div className="row">
                        ...
                        <div className="col-md-6 ">
                            <p>«CityNet» — это все преимущества с одним оператором связи: предоставление в рамках одного
                                подключения полного пакета высококачественных телекоммуникационных услуг таких как</p>
                            <p>
                                •	Подключение высокоскоростного и безлимитного Интернета <br/>
                                •	IP телефония <br/>
                                •	VPN <br/>
                                •	Интерактивное телевидение <br/>
                                •	Видеонаблюдение <br/>
                                •	Хостинг <br/>

                            </p>
                            <div className="third-arrow">
                                <a href="/internetDetails" className="font-family-medium">Подробнее <img
