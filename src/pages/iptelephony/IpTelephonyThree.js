                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <p style={{lineHeight: "24px"}}>•	Компания является признанным лидером в области информационных технологий в Узбекистане и партнёрами нашей компании являются страны СНГ, КНР и ЕС;
                                ...
                                <br/> •	Не менее важный плюс компании – это осуществление технической поддержки опытными специалистами, работающими по стандартам качества, в режиме 24/7;
                               <br/>  •	Очевидная и важная причина успеха компании – это ежедневное развитие и создание эффективных решений в области информационных технологий.
