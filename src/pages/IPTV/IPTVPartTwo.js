...
const IptvPartTwo = () => {
    return (
        <div className="iptv-part-two position-relative">
            <div className="line100">
            ...
            <div className="container iptv-part-two-child card-imageses">
                ...
                <div className="row">
                    ...
                    <div data-aos="fade-up"
                        ...
                        <p>
                            Отлаженная схема контроля качества выполнения работ на каждом этапе со стороны выделяемых
