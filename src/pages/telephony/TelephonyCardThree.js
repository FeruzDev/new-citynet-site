            ...
            <div className="container telephony-card-two-child">
                <div className="row d-flex">
                    ...
                    <div className="col-md-7">
                        <h4>Как работает IP-телефония?</h4>
                        <p>Суть передачи информации заключается в том, что сигнал переводится из аналогового формата
                            (голос) в цифровой, и подается на коммутирующее оборудование, где он зашифровывается и
                            сжимается. В дальнейшем, пакет информации попадает к адресату по сети Интернет, где
                            посредством специальных программ и аппаратуры происходит его перекодировка в первоначальный
                            вид.Именно поэтому данная технология преобразования голоса в цифровой сигнал и его обратное
                            декодирование получила название IP-телефония - VOIP. Таким образом, посредством сети
                            происходит телефонное общение между абонентами.
                        </p>
                    </div>
                </div>
            </div>
